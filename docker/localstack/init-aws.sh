...
awslocal sqs create-queue --queue-name recording-analysis --attributes '{"RedrivePolicy":"{\"deadLetterTargetArn\":\"arn:aws:sqs:ap-northeast-2:000000000000:recording-analysis-dlq\",\"maxReceiveCount\":\"3\"}"}'
